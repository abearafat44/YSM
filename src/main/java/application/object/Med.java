...
public class Med{
    ...
    public Med(Med m){
        ...
        this.description = new SimpleStringProperty(m.getDescription());
    ...
    //Added getters and setters for properties (J.W.)
    ...
    public StringProperty getStrengthProperty() {
        return strength;
    }
    ...
    public void setStrengthProperty (StringProperty strength) {
     ...
     * @throws IOException if the files are corrupted/missing
     */
    public void disposeLot(String lotNumber,boolean inApp,String txtName) throws IOException {
        int i =0;
